...
impl BenchmarkFunction {
    ...
    pub fn sphere(dimension: usize, rng: Option<Random>) -> Self {
    ...
    pub fn rastrigin(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
        BenchmarkFunction {
            name: "rstrigin",
    ...
    pub fn ackley(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
        BenchmarkFunction {
            name: "ackley",
    ...
    pub fn ackley_n4(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
        BenchmarkFunction {
            name: "ackleyN4",
    ...
    pub fn alpine_n1(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
        BenchmarkFunction {
            name: "alpineN1",
    ...
    pub fn alpine_n2(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
        BenchmarkFunction {
            name: "alpineN2",
    ...
    pub fn brown(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
        BenchmarkFunction {
            name: "brown",
    ...
    pub fn exponential(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
        BenchmarkFunction {
            name: "exponential",
    ...
    pub fn griewank(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
        BenchmarkFunction {
            name: "griewank",
    ...
    pub fn happy_cat(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
        BenchmarkFunction {
            name: "happyCat",
    ...
    pub fn periodic(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
        BenchmarkFunction {
            name: "periodic",
    ...
    pub fn powell_sum(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
        BenchmarkFunction {
            name: "powellSum",
    ...
    pub fn qing(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
        BenchmarkFunction {
            name: "qing",
    ...
    pub fn ridge(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
        BenchmarkFunction {
            name: "ridge",
    ...
    pub fn rosenbrock(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
        BenchmarkFunction {
            name: "rosenbrock",
    ...
    pub fn salomon(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
        BenchmarkFunction {
            name: "salomon",
    ...
    pub fn schwefel_220(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
        BenchmarkFunction {
            name: "schwefel220",
    ...
    pub fn schwefel_221(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
        BenchmarkFunction {
            name: "schwefel221",
    ...
    pub fn schwefel_222(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
        BenchmarkFunction {
            name: "schwefel222",
    ...
    pub fn schwefel_223(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
        BenchmarkFunction {
            name: "schwefel223",
    ...
    pub fn schwefel(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
        BenchmarkFunction {
            name: "schwefel",
    ...
    pub fn shubert_n3(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
        BenchmarkFunction {
            name: "shubertN3",
    ...
    pub fn shubert_n4(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
        BenchmarkFunction {
            name: "shubertN4",
    ...
    pub fn shubert(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
        BenchmarkFunction {
            name: "shubert",
    ...
    pub fn styblinksi_tank(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
        BenchmarkFunction {
            name: "styblinskiTank",
    ...
    pub fn sum_squares(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
        BenchmarkFunction {
            name: "sumSquares",
    ...
    pub fn yang_n2(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
        BenchmarkFunction {
            name: "yangN2",
    ...
    pub fn yang_n3(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
        BenchmarkFunction {
            name: "yangN3",
    ...
    pub fn yang_n4(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
        BenchmarkFunction {
            name: "yangN4",
    ...
    pub fn zakharov(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
        BenchmarkFunction {
            name: "zakharov",
    ...
    pub fn ackley_n2(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
    ...
    pub fn ackley_n3(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
        assert_eq!(dimension, 2);
        BenchmarkFunction {
            name: "ackleyN3",
    ...
    pub fn adjiman(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
        assert_eq!(dimension, 2);
        BenchmarkFunction {
            name: "adjiman",
    ...
    pub fn bartels_conn(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
        assert_eq!(dimension, 2);
        BenchmarkFunction {
            name: "bartelsConn",
    ...
    pub fn beale(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
        assert_eq!(dimension, 2);
        BenchmarkFunction {
            name: "beale",
    ...
    pub fn bird(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
        assert_eq!(dimension, 2);
        BenchmarkFunction {
            name: "bird",
    ...
    pub fn bohachevsky_n1(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
        assert_eq!(dimension, 2);
        BenchmarkFunction {
            name: "bohachevskyN1",
    ...
    pub fn bohachevsky_n2(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
        assert_eq!(dimension, 2);
        BenchmarkFunction {
            name: "bohachevskyN2",
    ...
    pub fn booth(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
        assert_eq!(dimension, 2);
        BenchmarkFunction {
            name: "booth",
    ...
    pub fn brent(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
        assert_eq!(dimension, 2);
        BenchmarkFunction {
            name: "brent",
    ...
    pub fn bukin_n6(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
        assert_eq!(dimension, 2);
        BenchmarkFunction {
            name: "bukinN6",
    ...
    pub fn cross_in_tray(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
        assert_eq!(dimension, 2);
        BenchmarkFunction {
            name: "crossInTray",
    ...
    pub fn deckkers_aarts(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
        assert_eq!(dimension, 2);
        BenchmarkFunction {
            name: "deckkersAarts",
    ...
    pub fn drop_wave(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
        assert_eq!(dimension, 2);
        BenchmarkFunction {
            name: "dropWave",
    ...
    pub fn easom(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
        assert_eq!(dimension, 2);
        BenchmarkFunction {
            name: "easom",
    ...
    pub fn egg_crate(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
        assert_eq!(dimension, 2);
        BenchmarkFunction {
            name: "eggCrate",
    ...
    pub fn goldstein_price(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
        assert_eq!(dimension, 2);
        BenchmarkFunction {
            name: "goldsteinPrice",
    ...
    pub fn gramacy_lee(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
    ...
    pub fn himmelblau(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
        assert_eq!(dimension, 2);
        BenchmarkFunction {
            name: "himmelblau",
    ...
    pub fn holder_table(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
        assert_eq!(dimension, 2);
        BenchmarkFunction {
            name: "holderTable",
    ...
    pub fn keane(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
        assert_eq!(dimension, 2);
        BenchmarkFunction {
            name: "keane",
    ...
    pub fn leon(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
        assert_eq!(dimension, 2);
        BenchmarkFunction {
            name: "leon",
    ...
    pub fn levi_n13(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
        assert_eq!(dimension, 2);
        BenchmarkFunction {
            name: "leviN13",
    ...
    pub fn matyas(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
        assert_eq!(dimension, 2);
        BenchmarkFunction {
            name: "matyas",
    ...
    pub fn mccormick(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
        assert_eq!(dimension, 2);
        BenchmarkFunction {
            name: "mccormick",
    ...
    pub fn schaffer_n1(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
        assert_eq!(dimension, 2);
        BenchmarkFunction {
            name: "schafferN1",
    ...
    pub fn schaffer_n2(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
        assert_eq!(dimension, 2);
        BenchmarkFunction {
            name: "schafferN2",
    ...
    pub fn schaffer_n3(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
        assert_eq!(dimension, 2);
        BenchmarkFunction {
            name: "schafferN3",
    ...
    pub fn schaffer_n4(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
        assert_eq!(dimension, 2);
        BenchmarkFunction {
            name: "schafferN4",
    ...
    pub fn three_hump_camel(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
        assert_eq!(dimension, 2);
        BenchmarkFunction {
            name: "threeHumpCamel",
    ...
    pub fn wolfe(dimension: usize, rng: Option<Random>) -> Self {
        let rng = &mut rng.unwrap_or_default();
...
impl Problem for BenchmarkFunction {
    ...
    fn evaluate(&self, solution: &Self::Encoding) -> f64 {
        (self.implementation)(solution, &self.rnd)
    }
...
pub mod scaled_implementations {
    ...
    //TODO: Unit test!
    pub fn shubert(x: &[f64], _rnd: &f64) -> f64 {
        let mut prod = 1.0;
        for i in 1..=(x.len()) {
            let mut sum = 0.0;
            for j in 1..=5 {
    ...
    pub fn yang_n1(x: &[f64], rnd: &f64) -> f64 {
        x.iter()
            .map(|xi| xi * 5.0)
            .enumerate()
            .map(|(i, xi)| rnd * (xi.abs()).powi(i as i32))
            .sum::<f64>()
    }
    ...
    //TODO: Unit test!
    pub fn zakharov(x: &[f64], _rnd: &f64) -> f64 {
        let i_sum = x.iter()
            .map(|xi| xi * 10.0)
            .enumerate()
    ...
    //TODO: Unit test!
    pub fn ackley_n2(x: &[f64], _rnd: &f64) -> f64 {
    ...
    /// Defined only on 2-dimensional space.
    //TODO: Unit test!
    pub fn ackley_n3(x: &[f64], _rnd: &f64) -> f64 {
        - 200.0 * (- 0.2 * ((x[0] * 32.0).powi(2) + (x[1] * 32.0).powi(2)).sqrt()).exp() +
    ...
    /// Defined only on 2-dimensional space.
    //TODO: Unit test!
    pub fn adjiman(x: &[f64], _rnd: &f64) -> f64 {
    ...
    /// Defined only on 2-dimensional space.
    //TODO: Unit test!
    pub fn bartels_conn(x: &[f64], _rnd: &f64) -> f64 {
    ...
    /// Defined only on 2-dimensional space.
    //TODO: Unit test!
    pub fn beale(x: &[f64], _rnd: &f64) -> f64 {
    ...
    /// Defined only on 2-dimensional space.
    //TODO: Unit test!
    pub fn bird(x: &[f64], _rnd: &f64) -> f64 {
        let a = x[0] * 2.0 * PI;
        let b = x[1] * 2.0 * PI;
    ...
    /// Defined only on 2-dimensional space.
    //TODO: Unit test!
    pub fn bohachevsky_n1(x: &[f64], _rnd: &f64) -> f64 {
        let a = x[0] * 100.0;
        let b = x[1] * 100.0;
    ...
    /// Defined only on 2-dimensional space.
    //TODO: Unit test!
    pub fn bohachevsky_n2(x: &[f64], _rnd: &f64) -> f64 {
        let a = x[0] * 100.0;
        let b = x[1] * 100.0;
    ...
    /// Defined only on 2-dimensional space.
    //TODO: Unit test!
    pub fn booth(x: &[f64], _rnd: &f64) -> f64 {
        let a = x[0] * 10.0;
        let b = x[1] * 10.0;
    ...
    pub fn brent(x: &[f64], _rnd: &f64) -> f64 {
        let a = - (x[0] * 20.0).abs();
        let b = - (x[1] * 20.0).abs();
    ...
    //TODO: Unit test!
    //TODO: For functions with range not symmetric around 0, look for better scaling options!
    pub fn bukin_n6(x: &[f64], _rnd: &f64) -> f64 {
        let a = x[0] * 15.0;
        let b = x[1] * 3.0;
    ...
    /// Defined only on 2-dimensional space.
    //TODO: Unit test!
    pub fn cross_in_tray(x: &[f64], _rnd: &f64) -> f64 {
        let a = x[0] * 10.0;
        let b = x[1] * 10.0;
    ...
    /// Defined only on 2-dimensional space.
    //TODO: Unit test!
    pub fn deckkers_aarts(x: &[f64], _rnd: &f64) -> f64 {
        let a = x[0] * 20.0;
        let b = x[1] * 20.0;
    ...
    /// Defined only on 2-dimensional space.
    //TODO: Unit test!
    pub fn drop_wave(x: &[f64], _rnd: &f64) -> f64 {
        let a = x[0] * 5.2;
        let b = x[1] * 5.2;
    ...
    /// Defined only on 2-dimensional space.
    //TODO: Unit test!
    pub fn easom(x: &[f64], _rnd: &f64) -> f64 {
        let a = x[0] * 100.0;
        let b = x[1] * 100.0;
    ...
    /// Defined only on 2-dimensional space.
    //TODO: Unit test!
    pub fn egg_crate(x: &[f64], _rnd: &f64) -> f64 {
        let a = x[0] * 5.0;
        let b = x[1] * 5.0;
    ...
    /// Defined only on 2-dimensional space.
    //TODO: Unit test!
    pub fn goldstein_price(x: &[f64], _rnd: &f64) -> f64 {
        let a = x[0] * 2.0;
        let b = x[1] * 2.0;
        (1.0 + (a + b + 1.0).powi(2) *
    ...
    //TODO: Unit test!
    pub fn gramacy_lee(x: &[f64], _rnd: &f64) -> f64 {
        let a = x[0] * 2.5;
    ...
    /// Defined only on 2-dimensional space.
    //TODO: Unit test!
    pub fn himmelblau(x: &[f64], _rnd: &f64) -> f64 {
        let a = x[0] * 6.0;
        let b = x[1] * 6.0;
    ...
    /// Defined only on 2-dimensional space.
    //TODO: Unit test!
    pub fn holder_table(x: &[f64], _rnd: &f64) -> f64 {
        let a = x[0] * 10.0;
        let b = x[1] * 10.0;
    ...
    /// Defined only on 2-dimensional space.
    //TODO: Unit test!
    pub fn keane(x: &[f64], _rnd: &f64) -> f64 {
        let a = (x[0] * 10.0).abs();
        let b = (x[1] * 10.0).abs();
    ...
    /// Defined only on 2-dimensional space.
    //TODO: Unit test!
    pub fn leon(x: &[f64], _rnd: &f64) -> f64 {
        let a = (x[0] * 10.0).abs();
        let b = (x[1] * 10.0).abs();
    ...
    /// Defined only on 2-dimensional space.
    //TODO: Unit test!
    pub fn levi_n13(x: &[f64], _rnd: &f64) -> f64 {
        let a = x[0] * 10.0;
        let b = x[1] * 10.0;
    ...
    /// Defined only on 2-dimensional space.
    //TODO: Unit test!
    pub fn matyas(x: &[f64], _rnd: &f64) -> f64 {
        let a = x[0] * 10.0;
        let b = x[1] * 10.0;
    ...
    /// Defined only on 2-dimensional space.
    //TODO: Unit test!
    pub fn mccormick(x: &[f64], _rnd: &f64) -> f64 {
        let a = x[0] * 4.0;
        let b = x[1] * 4.0;
    ...
    /// Defined only on 2-dimensional space.
    //TODO: Unit test!
    pub fn schaffer_n1(x: &[f64], _rnd: &f64) -> f64 {
        let a = x[0] * 100.0;
        let b = x[1] * 100.0;
    ...
    /// Defined only on 2-dimensional space.
    //TODO: Unit test!
    pub fn schaffer_n2(x: &[f64], _rnd: &f64) -> f64 {
        let a = x[0] * 100.0;
        let b = x[1] * 100.0;
    ...
    /// Defined only on 2-dimensional space.
    //TODO: Unit test!
    pub fn schaffer_n3(x: &[f64], _rnd: &f64) -> f64 {
        let a = x[0] * 100.0;
        let b = x[1] * 100.0;
    ...
    /// Defined only on 2-dimensional space.
    //TODO: Unit test!
    pub fn schaffer_n4(x: &[f64], _rnd: &f64) -> f64 {
        let a = x[0] * 100.0;
        let b = x[1] * 100.0;
    ...
    /// Defined only on 2-dimensional space.
    //TODO: Unit test!
    pub fn three_hump_camel(x: &[f64], _rnd: &f64) -> f64 {
        let a = x[0] * 100.0;
        let b = x[1] * 100.0;
    ...
    //TODO: Unit test!
    pub fn wolfe(x: &[f64], _rnd: &f64) -> f64 {
        let a = (x[0] * 2.0).abs();
        let b = (x[1] * 2.0).abs();
        let c = (x[2] * 2.0).abs();
